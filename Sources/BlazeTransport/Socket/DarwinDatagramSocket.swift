...
/// Darwin (macOS/iOS) UDP socket implementation using POSIX BSD sockets.
final class DarwinDatagramSocket: DatagramSocket {
    ...
    init() throws {
        ...
        let setFlagsResult = Darwin.fcntl(socketFD, F_SETFL, flags | O_NONBLOCK)
    ...
    func bind(host: String, port: UInt16) throws {
        ...
        if host == "0.0.0.0" || host == "127.0.0.1" || host == "localhost" {
            ...
            let hostent = Darwin.gethostbyname(host)
