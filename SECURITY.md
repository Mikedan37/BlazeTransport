...
BlazeTransport provides comprehensive security through integrated encryption, authentication, and replay protection. This document describes the security architecture, threat model, failure modes, and security guarantees.
